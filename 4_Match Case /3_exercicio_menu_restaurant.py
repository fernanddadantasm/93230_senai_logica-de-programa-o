...
#Faça um algoritmo que mostre um menu com opçoes de um cardápio de restaurante para uma pessoa
#A pessoa vai escolher o prato desejado digitando o codigo do prato.
#Apos escolher o prato, o algoritmo deve mostrar o nome e o valor do prato escolhido. 
